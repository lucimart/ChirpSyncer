...
**Pending migration (single files):**
- DataTable
- DangerConfirm
- ConnectionStatus
- CollapsibleMenu
...
### Next Actions
- Migrate remaining components: DataTable, DangerConfirm, ConnectionStatus, etc.
- Replace duplicate spinner @keyframes with `ui/Spinner` across codebase.
