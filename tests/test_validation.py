...
def test_validate_credentials_all_present():
    ...
    with patch('app.validation.TWITTER_USERNAME', 'test_twitter_user'), \
         patch('app.validation.TWITTER_PASSWORD', 'test_twitter_pass'), \
         patch('app.validation.TWITTER_EMAIL', 'test@example.com'), \
         patch('app.validation.TWITTER_EMAIL_PASSWORD', 'test_email_pass'), \
...
def test_validate_credentials_empty():
    ...
    with patch('app.validation.TWITTER_USERNAME', ''), \
         patch('app.validation.TWITTER_PASSWORD', 'test_twitter_pass'), \
         patch('app.validation.TWITTER_EMAIL', 'test@example.com'), \
         patch('app.validation.TWITTER_EMAIL_PASSWORD', '   '), \
