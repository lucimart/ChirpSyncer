...
class TestTwitterAPIHandler:
    ...
    def test_init_missing_credentials(self):
        ...
        with pytest.raises(ValueError, match="All Twitter API credentials are required"):
            TwitterAPIHandler(
                api_key='',
                api_secret='test_secret',
                access_token='test_token',
    ...
    def test_post_tweet_with_media(self, mock_client_class):
        ...
        tweet_id = handler.post_tweet("Test tweet with media", media_ids=['media123', 'media456'])
    ...
    def test_from_credentials_dict_missing_keys(self):
        ...
        with pytest.raises(ValueError, match="Missing required credential keys"):
...
class TestHelperFunctions:
    ...
    def test_post_tweet_with_credentials_success(self, mock_oauth, mock_client_class, mock_api_class):
    ...
    @patch('app.integrations.twitter_api_handler.tweepy.Client')
    @patch('app.integrations.twitter_api_handler.tweepy.OAuth1UserHandler')
    def test_post_tweet_with_credentials_and_media(self, mock_oauth, mock_client_class, mock_api_class):
