...
def test_fetch_tweets_returns_list(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen, mock_tweet_data
):
...
@patch("app.integrations.twitter_scraper.is_tweet_seen")
@patch("app.integrations.twitter_scraper.API")
def test_fetch_tweets_with_count(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen, mock_tweet_data
):
...
@patch("app.integrations.twitter_scraper.is_tweet_seen")
@patch("app.integrations.twitter_scraper.API")
def test_tweet_format_matches_expected(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen, mock_tweet_data
):
...
@patch("app.integrations.twitter_scraper.is_tweet_seen")
@patch("app.integrations.twitter_scraper.API")
def test_fetch_tweets_filters_seen_tweets(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen, mock_tweet_data
):
    ...
    # Note: is_tweet_seen is called with (tweet_id, conn) - 2 arguments
    mock_is_tweet_seen.side_effect = lambda tweet_id, conn=None: tweet_id == 987654321
...
@patch("app.integrations.twitter_scraper.is_tweet_seen")
@patch("app.integrations.twitter_scraper.API")
def test_fetch_tweets_all_seen(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen, mock_tweet_data
):
...
@patch("app.integrations.twitter_scraper.is_tweet_seen")
@patch("app.integrations.twitter_scraper.API")
def test_fetch_tweets_no_tweets_returned(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen
):
...
@patch("app.integrations.twitter_scraper.is_tweet_seen")
@patch("app.integrations.twitter_scraper.API")
def test_fetch_tweets_async_exception(
    mock_api_class, mock_is_tweet_seen, mock_mark_tweet_as_seen
):
...
def test_tweet_adapter_repr():
    ...
    mock_tweet.id = 12345
    mock_tweet.rawContent = (
        "This is a test tweet with more than fifty characters to test truncation"
    )
